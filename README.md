# Veai media — arXiv-дайджест «Риски и качество ИИ-кода» (29 июня–04 июля 2026)
...
| `arxiv/*.html` | 15 страниц-переводов статей, на которые ссылается главная |
...
- Главная → `assets/veai-logo.svg`, 15 × `arxiv/2606.*.html`
